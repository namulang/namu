...
{
	template
	class NE_DLL NEKeyTemplate<NEManagedNodeSet, NEType::NEMANAGED_NODE_SET_KEY>;
	typedef NEKeyTemplate<NEManagedNodeSet, NEType::NEMANAGED_NODE_SET_KEY> NEManagedNodeSetKey;
}
