...
{
	template
	class NE_DLL NEKeyTemplate<NEModuleCodeSet, NEType::NEMODULE_CODESET_KEY>;
	typedef NEKeyTemplate<NEModuleCodeSet, NEType::NEMODULE_CODESET_KEY> NEModuleCodeSetKey;
}
