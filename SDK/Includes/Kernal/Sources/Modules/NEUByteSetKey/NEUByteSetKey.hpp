...
#include "../NEUByteSet/NEUByteSet.hpp"

namespace NE
{
	template
	class NE_DLL NEKeyTemplate<NEUByteSet, NEType::NEUBYTE_SET_KEY>;
	typedef NEKeyTemplate<NEUByteSet, NEType::NEUBYTE_SET_KEY> NEUByteSetKey;
}
