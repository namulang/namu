namespace NE
{
	...
	NEIndexedArrayTemplate<Type*, false, type>::NEIndexedArrayTemplate()
	...
	//	---------------------------------------------------------------------------------
	template <typename Type, NEType::Type type>
	NEIndexedArrayTemplate<Type*, false, type>::NEIndexedArrayTemplate(type_count size)
	...
	//	---------------------------------------------------------------------------------
	template <typename Type, NEType::Type type>
	NEIndexedArrayTemplate<Type*, false, type>::NEIndexedArrayTemplate(const ThisClass& source)
		: SuperClass(), _data(NE_NULL)
	{
		_assign(source);
	}	
	...
	//	---------------------------------------------------------------------------------
	template <typename Type, NEType::Type type>
	const NEIndexedArrayTemplate<Type*, false, type>&
		NEIndexedArrayTemplate<Type*, false, type>::operator=
		(
	...
	//	---------------------------------------------------------------------------------
	template <typename Type, NEType::Type type>
	NEIndexedArrayTemplate<Type*, false, type>  
		NEIndexedArrayTemplate<Type*, false, type>::operator+
		(
		const ThisClass& source
		) const
	...
	//	---------------------------------------------------------------------------------	
	template <typename Type, NEType::Type type>
	bool  NEIndexedArrayTemplate<Type*, false, type>::operator==(const NEIndexedArrayTemplate<Type*, false, type>& source) const
	{
	...
	//	---------------------------------------------------------------------------------
	template <typename Type, NEType::Type type>
	Type& NEIndexedArrayTemplate<Type*, false, type>::getElement(type_index index) 
	{	
		//	pre:
		//		널 레퍼런스:
	...
	//	---------------------------------------------------------------------------------
	template <typename Type, NEType::Type type>
	const Type& NEIndexedArrayTemplate<Type*, false, type>::getElement(type_index index) const 
	{	
		//	pre:
		//		널 레퍼런스:
		Type* null_pointer = NE_NULL;
	...
	//	---------------------------------------------------------------------------------
	template <typename Type, NEType::Type type>
	type_result NEIndexedArrayTemplate<Type*, false, type>::setElement(type_index index, const Type* const source)
	{
		//	pre:
		//		파라메터검사:
	...
	//	---------------------------------------------------------------------------------
	template <typename Type, NEType::Type type>
	type_result NEIndexedArrayTemplate<Type*, false, type>::resize(type_count size) // 가지고있는 데이터는 보존한채 크기만 변경한다.
	{
		//	pre:
		...
		for(int n=0; n < copied_in_heap._occupiedset.getSize() ;n++)
			insert(n, copied_in_heap[n]);	//	source.getElement(n)이 올바르지 않으면 *null가 나오고, 이는 insert에서 검출할 수 있다.
	...
	//	---------------------------------------------------------------------------------
	template <typename Type, NEType::Type type>
	type_result NEIndexedArrayTemplate<Type*, false, type>::push(const ThisClass& source)
	{
		//	pre:
		//		파라메터검사:
	...
	//	---------------------------------------------------------------------------------
	template <typename Type, NEType::Type type>
	type_result NEIndexedArrayTemplate<Type*, false, type>::pushFront(const ThisClass& source)
	{
		//	pre:
		//		파라메터 검사:
		if( ! source.getLength() )	return RESULT_TYPE_WARNING | RESULT_WRONG_PARAMETER | RESULT_ABORT_ACTION;
	...
	template <typename Type, NEType::Type type>
	type_index NEIndexedArrayTemplate<Type*, false, type>::insert(type_index index, const Type* const source) 
	{
		//	pre:
		//		파라메터검사:
	...
	//	---------------------------------------------------------------------------------
	template <typename Type, NEType::Type type>
	type_result NEIndexedArrayTemplate<Type*, false, type>::remove(type_index index) 
	{
		//	pre:
		//		파라메터검사:
		if(index < 0) return NE_INDEX_ERROR;
	...
	//	---------------------------------------------------------------------------------
	template <typename Type, NEType::Type type>
	bool  NEIndexedArrayTemplate<Type*, false, type>::isEqualSizeAndElement(const ThisClass& source) const
	{
		//	pre:
	...
	//	---------------------------------------------------------------------------------
	template <typename Type, NEType::Type type>
	bool  NEIndexedArrayTemplate<Type*, false, type>::isEqualElement(const ThisClass& source) const
	{
	...
	//	---------------------------------------------------------------------------------
	template <typename Type, NEType::Type type> 
	type_result NEIndexedArrayTemplate<Type*, false, type>::isValid() const  
	{
		//	상위 클래스의 valid 체크:
	...
	//	---------------------------------------------------------------------------------
	template <typename Type, NEType::Type type>
	void  NEIndexedArrayTemplate<Type*, false, type>::release()  
	{		
		_release();
		/*
			의도적인 역순 처리:
	...
	//	---------------------------------------------------------------------------------
	template <typename Type, NEType::Type type>
	NEType::Type NEIndexedArrayTemplate<Type*, false, type>::getType() const
	{
		return type;
	}
	...
	//	---------------------------------------------------------------------------------
	template <typename Type, NEType::Type type>
	type_result NEIndexedArrayTemplate<Type*, false, type>::create(type_count size)
	{
		release();
	...
	template <typename Type, NEType::Type type>
	const NEIndexedArrayTemplate<Type*, false, type>&
		NEIndexedArrayTemplate<Type*, false, type>::_assign
		(
		const ThisClass& source
		)
	{	
	...
	//	---------------------------------------------------------------------------------
	template <typename Type, NEType::Type type>
	void  NEIndexedArrayTemplate<Type*, false, type>::_release() 
	{	
		if(_data)
			delete [] _data;
		_data = NE_NULL;
	...
	template <typename Type, NEType::Type type>
	type_index NEIndexedArrayTemplate<Type*, false, type>::push(const Type* const source)
	{
	...
	template <typename Type, NEType::Type type>
	type_index NEIndexedArrayTemplate<Type*, false, type>::pop()
	{
	...
	template <typename Type, NEType::Type type>
	type_index NEIndexedArrayTemplate<Type*, false, type>::pushFront(const Type* const source)
	{
	...
	template <typename Type, NEType::Type type>
	type_index NEIndexedArrayTemplate<Type*, false, type>::popFront()
	{
	...
	//     	---------------------------------------------------------------------------------
	template <typename Type, NEType::Type type>
	type_index NEIndexedArrayTemplate<Type*, false, type>::find(const Type* const source) const
	{
		//	pre:
		//		관련멤버변수 검사:
	...
	template <typename Type, NEType::Type type>
	type_index NEIndexedArrayTemplate<Type*, false, type>::_searchIndex(bool by_descreasing, bool target_is_occupied) const
	{
		if( ! by_descreasing)
		{
	...
	template <typename Type, NEType::Type type>
	NEBinaryFileSaver& NEIndexedArrayTemplate<Type*, false, type>::serialize(NEBinaryFileSaver& saver) const
	{
	...
	template <typename Type, NEType::Type type>
	NEBinaryFileLoader& NEIndexedArrayTemplate<Type*, false, type>::serialize(NEBinaryFileLoader& loader)
	{
		//	pre:
	...
	template <typename Type, NEType::Type type>
	NEObject& NEIndexedArrayTemplate<Type*, false, type>::clone() const
	{
	...
	template <typename Type, NEType::Type type>
	type_index NEIndexedArrayTemplate<Type*, false, type>::insert(type_index index, const Type& source)
	{
		return insert(index, &source);
	}

	template <typename Type, NEType::Type type>
	type_index NEIndexedArrayTemplate<Type*, false, type>::pushFront(const Type& source)
	{
	...
	template <typename Type, NEType::Type type>
	const NEOccupiedSet& NEIndexedArrayTemplate<Type*, false, type>::getOccupiedSet() const
	{
		return _occupiedset;
	}
}