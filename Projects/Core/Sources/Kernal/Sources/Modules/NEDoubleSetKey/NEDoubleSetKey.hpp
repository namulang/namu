...
#include "../NEDoubleSet/NEDoubleSet.hpp"

namespace NE
{
	template
	class NE_DLL NEKeyTemplate<NEDoubleSet, NEType::NEDOUBLE_SET_KEY>;
	typedef NEKeyTemplate<NEDoubleSet, NEType::NEDOUBLE_SET_KEY> NEDoubleSetKey;
}
