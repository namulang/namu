...
#include "../NEShortSet/NEShortSet.hpp"

namespace NE
{
	template
	class NE_DLL NEKeyTemplate<NEShortSet, NEType::NESHORT_SET_KEY>;
	typedef NEKeyTemplate<NEShortSet, NEType::NESHORT_SET_KEY> NEShortSetKey;
}
