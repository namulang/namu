...
#include "../NEUIntSet/NEUIntSet.hpp"

namespace NE
{
	template
	class NE_DLL NEKeyTemplate<NEUIntSet, NEType::NEUINT_SET_KEY>;
	typedef NEKeyTemplate<NEUIntSet, NEType::NEUINT_SET_KEY> NEUIntSetKey;
}
