...
#include "Alignment.hpp"
	...
	private:
		NEModuleBinder _font_binder;

	public:
		static const NECodeSet& getTexterCodeSet()
		{
			...
			{
				_instance.create(1);
				_instance.push(Kernal::getInstance().getModuleManager()
					.getModule(SpriteTexter().getHeader()).getScriptCode());
			}
