...
echo *		Library files 
echo *			from '../../../Binaries' 
echo *			to './copy_this_content_into_your_sdk_path/Libraries/Module'
echo *
echo * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
pause
...
echo * Library files : ./copy_this_content_into_your_sdk_path/Libraries/Module
...
md copy_this_content_into_your_sdk_path\Libraries\Module
...
xcopy /Y /E ..\..\..\Binaries\%project_name% .\copy_this_content_into_your_sdk_path\Libraries\Module
