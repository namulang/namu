...
namespace DX9Graphics
{
	...
	*/
	template
	class NE_DLL NEArrayTemplate<RenderTarget*, true>;

	class NE_DLL RenderTargetSet : public NEArrayTemplate<RenderTarget*, true>
	{
	public:
		typedef NEArrayTemplate<RenderTarget*, true> SuperClass;
