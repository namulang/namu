...
#undef PAIRX
    ...
    err* me::newErr(int code, va_list args) { return new err(logLv::ERR, code, args); }
    ...
    err* me::newWarn(int code, va_list args) { return new err(logLv::WARN, code, args); }
    ...
    err* me::newInfo(int code, va_list args) { return new err(logLv::INFO, code, args); }
    ...
    me::err(logLv::level t, nint newCode):
        super(), fType(t), code((errCode) newCode), msg(getErrMsg(code)), pos{} {
        _initStack();
    }

    me::err(logLv::level t, nint newCode, va_list args):
        super(), fType(t), code((errCode) newCode), msg(_format(getErrMsg(code), args)), pos{} {
        _initStack();
    }
    ...
    scope& me::subs() {
        static scope inner =
            tbridger<me>::func("log", &me::log).func("logStack", &me::logStack).subs();
