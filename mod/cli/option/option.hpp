...
namespace wrd {
    ...
    struct cli;
    class option : public instance, public clonable {
        WRD(INTERFACE(option, instance))

    public:
        virtual const wchar* getName() const = 0;
        virtual const wchar* getDescription() const = 0;

        /// @return how many argument taken by this option.
    ...
    typedef std::vector<tstr<option>> options;
}
