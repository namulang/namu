namespace W
{
	...
	class MyFirstWorldModule : public Object {
		static const Result& _onInitializeMethods(List<Methods> tray) {
			W_DECL_FUNC(String& addString(String& arg1, String/*by val is ok.*/ arg2))
		...
		//	사용자는 이걸 따로 만들어야 한다.
		//	반환값은 동일하게
		String& addString(String& arg1, String arg2/*값 복사가 1번더 일어난다*/) {
			static String added;
			added = arg1 + arg2;
			return added;
		}
		Reference addString(String& arg1, String& arg2) {
			//	Reference의 사용방법1 : 
